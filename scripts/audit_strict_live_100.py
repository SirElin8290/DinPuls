...
FILES=['municipalities.json','important.json','important-sources.json','weather-live.json','road-traffic.json','transport.json','flights.json','jobs.json','housing.json','housing-fargelanda-supplement.json','events.json','events-fargelanda-supplement.json','news.json','missing-people.json','health.json','health-private.json','health-private-supplement.json','health-local-supplement.json','health-karlstad-private-supplement.json','health-fargelanda-supplement.json','service.json','service-private-supplement.json','service-launch-supplement.json','service-local-supplement.json','authorities.json','authorities-hagfors-supplement.json','authorities-arjang-supplement.json','authorities-arvika-supplement.json','lunch.json','cinemas.json','leisure.json','leisure-enrichment.json','leisure-fargelanda-supplement.json','sports.json','sports-fargelanda-supplement.json','association-hagfors-supplement.json','community-sources.json','community-posts.json']
def load_repo(fn):
 try:v=json.loads((DATA/fn).read_text(encoding='utf-8'));return v if isinstance(v,dict) else {}
 except Exception:return {}
def load(fn):
 try:
  req=urllib.request.Request(LIVE+fn,headers={'User-Agent':'DinPuls-Strict-Audit/1.2'});r=urllib.request.urlopen(req,timeout=8);v=json.loads(r.read().decode('utf-8'));r.close()
