...
def fetch(key):
    body=f'''<REQUEST><LOGIN authenticationkey="{key}"/><QUERY objecttype="Situation" schemaversion="1.5" limit="1000"><FILTER><EQ name="Deleted" value="false"/></FILTER><INCLUDE>Id</INCLUDE><INCLUDE>ModifiedTime</INCLUDE><INCLUDE>Deviation</INCLUDE></QUERY></REQUEST>'''.encode()
