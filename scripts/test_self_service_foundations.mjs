...
const entryHtml = await readFile(new URL("../foretag/start.html", import.meta.url), "utf8");
const welcomeHtml = await readFile(new URL("../foretag/valkommen.html", import.meta.url), "utf8");
const footerHtml = await readFile(new URL("../components/footer.html", import.meta.url), "utf8");
const entryCss = await readFile(new URL("../foretag/start.css", import.meta.url), "utf8");
assert.match(footerHtml, /href="foretag\/valkommen\.html"[^>]*>Företag/);
assert.match(welcomeHtml, /href="start\.html"[^>]*>Logga in/);
