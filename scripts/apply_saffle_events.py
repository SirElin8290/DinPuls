#!/usr/bin/env python3
"""Lägger in verifierade Säffle-evenemang efter den ordinarie eventgeneratorn."""
...
SUPPLEMENT = ROOT / "data" / "events-saffle-supplement.json"
...
def main() -> int:
    ...
    print(f"Säffle: {len(supplement_events)} verifierade supplement-evenemang, totalt {len(retained)} poster")
    return 0
