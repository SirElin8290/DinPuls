...
const contract = {
  ...
  endDate: "2027-09-14", billingType: "annual", price: 8000, monthlyTotal: 0, annualTotal: 16000,
...
for (const expected of ["DINPULS – FAKTURAUNDERLAG", "DP-2026-0001", "556000-0000", "Anna Andersson", "Åmål", "P1-01", "P1-02", "2026-09-15 – 2027-09-14", "Årsvis i förskott", "Antal platser: 2", "Pris per plats: 8 000 kr", "Årsbelopp: 16 000 kr", "10 dagar netto", "exklusive moms"]) assert.ok(basis.includes(expected), `Fakturaunderlaget saknar ${expected}`);
