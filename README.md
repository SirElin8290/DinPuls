...
Version 0.23.4 avslutar webbplatsens första stabiliseringsomgång: säkerhetsfunktioner och gemensamma hjälpfunktioner är centraliserade, CSS använder en gemensam palett och testerna körs automatiskt före lansering.
...
- Restauranger utan maskinläsbar meny visas med direktlänk till sin aktuella
  meny.
- Fyra lokala annonsplatser på lunchsidan för 800 kr per månad plus moms.
...
- Fyra separata lokala annonsplatser på evenemangssidan enligt 800 kr/månad plus moms-modellen.
...
- Matkassesidan har fyra kategoriannonsplatser enligt nivån 800 kr per månad plus moms.
...
- Startsidan har tre roterande annonsgrupper med tio platser per grupp,
  totalt 30 platser avsedda för 800 kr per månad plus moms.
- Jobb- och bostadssidorna har kategoriannonser avsedda för 800 kr per månad plus moms.
